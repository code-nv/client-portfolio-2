...
function luke_fair_styles()
{
    ...
    wp_enqueue_script('main_scripts', get_theme_file_uri('/js/script12.js'), null, '1.0', true);
    wp_enqueue_style('style', get_template_directory_uri() . '/css/styles15.css', null, '1.0.0', 'all');
};
